...
HOW TO MAKE A NEW ENEMY
    ...
    Make animations for the enemy. (Make sure "Loop Time" is checked for each one except for the dying animation.) 
    Duplicate/rename the EnemyAnimator controller and add it to the enemy under "Controller" in the Animator 
    component. Open the controller and add an animation to each state by dragging it onto the state's "Motion" 
